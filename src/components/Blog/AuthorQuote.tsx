...
const AuthorQuote = () => {
  return (
    <div
      className="wow fadeInUp relative z-10 mb-10 overflow-hidden rounded bg-rose-700 bg-opacity-5 px-6 py-8 text-center sm:p-10 md:px-[60px]"
      data-wow-delay=".1s"
    >
      <div className="mx-auto max-w-[530px]">
        <span className="mb-6 flex justify-center text-rose-700">
          <svg
            width="44"
            height="26"
            viewBox="0 0 44 26"
