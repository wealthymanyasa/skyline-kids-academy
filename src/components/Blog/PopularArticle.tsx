      ...
      >
        ...
        <div className="w-full">
          <h4>
            <Link
              href="/#"
              className="mb-1 inline-block text-lg font-medium leading-snug text-dark hover:text-rose-700 dark:text-dark-6 dark:hover:text-rose-700 lg:text-base xl:text-lg"
            >
              {title}
            </Link>
          </h4>
