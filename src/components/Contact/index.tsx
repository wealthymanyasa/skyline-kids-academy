...
const Contact = () => {
  ...
  const sendEmail = (e: any) => {
    ...
    emailjs.sendForm('service_mskkhms', 'template_tymek96', form.current || '', 'TZI8Wd3Ww4Nf77hKP')
      .then((result) => {
            ...
            <div className="ud-contact-content-wrapper">
              <div className="ud-contact-title mb-12 lg:mb-[150px]">
                ...
                <h2 className="max-w-[260px] text-[35px] font-semibold leading-[1.14] text-dark dark:text-white">
                  Let&#39;s talk about your children&#39;s future.
                </h2>
              </div>
              <div className="mb-12 flex flex-wrap justify-between lg:mb-0">
                <div className="mb-8 flex w-[330px] max-w-full">
                  <div className="mr-6 text-[32px] text-rose-700">
                    <svg
                      width="29"
                      height="35"
                      viewBox="0 0 29 35"
                  ...
                  <div>
                    ...
                    <p className="text-base text-body-color dark:text-dark-6">
                      Stand Number 1796, Surburbs, Jerera Growth Point
                    </p>
                  </div>
                </div>
                <div className="mb-8 flex w-[330px] max-w-full">
                  ...
                  <div>
                    ...
                    <p className="text-base text-body-color dark:text-dark-6">
                    skylinekidsacademy@hotmail.com
                    </p>
                    <p className="mt-1 text-base text-body-color dark:text-dark-6">
                      hrskylinekids@yahoo.com
                    </p>
                    <h3 className="mb-[18px] mt-4 text-lg font-semibold text-dark dark:text-white">
                      Phone
                    </h3>
                    <p className="mt-1 text-base text-body-color dark:text-dark-6">
                      +263 786 448 566
              ...
              <form ref={form} onSubmit={sendEmail} >
                <div className="mb-[22px]">
                  ...
                  <input
                    ...
                    className="w-full border-0 border-b border-[#f1f1f1] bg-transparent pb-3 text-dark placeholder:text-body-color/60 focus:border-rose-700 focus:outline-none dark:border-dark-3 dark:text-white"
                  />
                </div>
                <div className="mb-[22px]">
                  <label
                ...
                <div className="mb-[30px]">
                  ...
                  <textarea
                    ...
                    className="w-full resize-none border-0 border-b border-[#f1f1f1] bg-transparent pb-3 text-dark placeholder:text-body-color/60 focus:border-rose-700 focus:outline-none dark:border-dark-3 dark:text-white"
                  ></textarea>
                </div>
                <div className="mb-0">
                  <button
                    type="submit"
                    className="inline-flex items-center justify-center rounded-md bg-rose-700 px-10 py-3 text-base font-medium text-white transition duration-300 ease-in-out hover:bg-rose-700/90"
                  >
                    Send
                  </button>
                  <Toaster />
