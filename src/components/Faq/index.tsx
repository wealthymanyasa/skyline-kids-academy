      ...
      <div className="container">
        ...
        <div className="-mx-4 mt-[60px] flex flex-wrap lg:mt-20">
          <div className="w-full px-4 lg:w-1/2">
            <SingleFaq
              question="What age groups does Skyline Kids Academy serve?"
              answer="Skyline Kids Academy caters to children aged 3 to 12 years, encompassing early childhood education through primary school levels."
            />
            <SingleFaq
              question="What is the student-to-teacher ratio?"
              answer="We maintain a low student-to-teacher ratio of 15:1 to ensure personalized attention and a supportive learning environment for each child."
            />
            <SingleFaq
              question="How does the academy handle student assessments?"
              answer="We use a combination of formative and summative assessments, including regular quizzes, projects, and observations, to monitor student progress and tailor instruction accordingly."
            />
          </div>

          <div className="w-full px-4 lg:w-1/2">
            <SingleFaq
              question="How can parents get involved in the school community?"
              answer="We encourage parental involvement through regular communication, parent-teacher conferences, volunteer opportunities, and participation in school events and committees."
            />
            <SingleFaq
              question="What steps are taken to ensure student health and wellness?"
              answer="We prioritize student health by maintaining clean facilities, promoting regular handwashing and e conduct regular wellness programs to educate students on healthy habits."
            />
            <SingleFaq
              question="How does the academy handle emergencies or inclement weather?"
              answer="In the event of emergencies or severe weather conditions, we follow the guidelines set by local authorities. Families are notified promptly through our communication channels, including whatsapp and text alerts."
            />
          </div>
        </div>
      </div>
