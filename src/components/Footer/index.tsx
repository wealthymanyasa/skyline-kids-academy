        ...
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12">
            <div className="mb-10 w-full">
              ...
              <h1 className="text-white font-stretch-[99%] dark:text-white font-sans font-extrabold w-full">
                      SKYLINE KIDS ACADEMY
                    </h1>
              </Link>
              <p className="mb-8 max-w-[270px] text-base text-gray-7">

                We design impactful learning experiences that empower students to achieve their full potential.
              </p>
            ...
            <div className="mb-10 w-full">
              ...
              <ul>
                <li>
                  <a
                    href="#header"
                    className="mb-3 inline-block text-base text-gray-7 hover:text-rose-700"
                  >
                    Home
                  </a>
                </li>
          ...
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-3/12 xl:w-2/12">
            <div className="mb-10 w-full">
              ...
              <ul>
                ...
                <li>
                  <a
                    href="https://api.whatsapp.com/send?phone=263786448566"
                    className="mb-3 inline-block text-base text-gray-7 hover:text-rose-700"
                  >
                    Whatsapp
                  </a>
                ...
                <li>
                  <a
                    href="https://api.whatsapp.com/send?phone=263777530423"
                    className="mb-3 inline-block text-base text-gray-7 hover:text-rose-700"
                  >
                    Admin
                  </a>
