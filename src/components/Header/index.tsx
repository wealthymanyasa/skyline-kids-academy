          ...
          <div className="relative -mx-4 flex items-center justify-between">
            <div className="w-60 max-w-full px-4 ">
              ...
              >
                {pathUrl !== "/" ? (
                  <>
                    <h1 className="text-black dark:text-white font-sans font-extrabold w-full">
                      SKYLINE KIDS ACADEMY
                    </h1>
                    {/* <Image
                  ...
                  <>
                    <h1 className="text-white font-sans font-extrabold w-full">
                      SKYLINE KIDS ACADEMY
                    </h1>
            ...
            <div className="flex w-full items-center justify-between px-4">
              <div>
                <button
                  ...
                  className="absolute right-4 top-1/2 block -translate-y-1/2 rounded-lg px-3 py-[6px] ring-rose-700 focus:ring-2 lg:hidden"
                >
                  <span
                        ...
                        <li key={index} className="group relative">
                          {pathUrl !== "/" ? (
                            <Link
                              ...
                              scroll={false}
                              href={menuItem.path}
                              className={`ud-menu-scroll flex py-2 text-base text-dark group-hover:text-rose-700 dark:text-white dark:group-hover:text-rose-700 lg:inline-flex lg:px-0 lg:py-6 ${pathUrl === menuItem?.path && "text-rose-700"
                                }`}
                            >
                              {menuItem.title}
                            </Link>
                            ...
                            <Link
                              ...
                              className={`ud-menu-scroll flex py-2 text-base lg:inline-flex lg:px-0 lg:py-6 ${sticky
                                ? "text-dark group-hover:text-rose-700 dark:text-white dark:group-hover:text-rose-700"
                        ...
                        <li className="submenu-item group relative" key={index}>
                          {pathUrl !== "/" ? (
                            <button
                              ...
                              className={`ud-menu-scroll flex items-center justify-between py-2 text-base text-dark group-hover:text-rose-700 dark:text-white dark:group-hover:text-rose-700 lg:inline-flex lg:px-0 lg:py-6`}
                            >
                              {menuItem.title}
                            ...
                            {menuItem?.submenu?.map((submenuItem: any, i) => (
                              <Link
                                ...
                                className={`block rounded px-4 py-[10px] text-sm ${pathUrl === submenuItem.path
                                  ? "text-rose-700"
                                  : "text-body-color hover:text-rose-700 dark:text-dark-6 dark:hover:text-rose-700"
                                  }`}
                              >
                                {submenuItem.title}
                              </Link>
                ...
                {/* {session?.user ? (
                  <>
                    ...
                    {pathUrl !== "/" || sticky ? (
                      <button
                        onClick={() => signOut()}
                        className="signUpBtn rounded-lg bg-rose-700 bg-opacity-100 px-6 py-3 text-base font-medium text-white duration-300 ease-in-out hover:bg-opacity-20 hover:text-dark"
                      >
                        Sign Out
                      </button>
                    ) : (
                  ...
                  <>
                    {pathUrl !== "/" ? (
                      <>
                        ...
                        <Link
                          href="/signup"
                          className="rounded-lg bg-rose-700 px-6 py-3 text-base font-medium text-white duration-300 ease-in-out hover:bg-rose-700/90 dark:bg-white/10 dark:hover:bg-white/20"
                        >
                          Sign Up
                        </Link>
                      </>
                      ...
                      <>
                        ...
                        <Link
                          ...
                          className={`rounded-lg px-6 py-3 text-base font-medium text-white duration-300 ease-in-out ${sticky
                              ? "bg-rose-700 hover:bg-rose-700/90 dark:bg-white/10 dark:hover:bg-white/20"
